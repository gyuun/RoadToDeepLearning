...
This project documents my journey in deep learning, providing implementation examples and resources for those studying neural networks.

본 저장소는 딥러닝을 공부하는 과정에서 구현한 코드와 리소스를 제공합니다.
...
git clone https://github.com/gyuun/RoadToDeepLearning.git
